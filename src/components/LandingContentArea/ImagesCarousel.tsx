...
function ImagesCarousel() {
  ...
  return (
    <div className="relative w-full h-[30vh] xs:h-[40vh] md:h-[80vh] overflow-hidden">
      {/* <p className="absolute top-[80%] left-1/2 w-[70vw] md:w-[50vw] text-center transform -translate-x-1/2 -translate-y-1/2 text-white font-bodoni italic leading-3 lg:leading-10 font-extrabold md:tracking-wide text-base xs:text-lg md:text-2xl lg:text-4xl z-50">
        Zan Extreme Holidays and Wildlife Safaris!
      </p> */}
